...
cp_left_data_gen <- function(size=2600,p=0.22,
                             beta1=c(1,1,0.5,0.5),beta2 = c(1,-1,0.5,-0.5),
                             phi=c(1,1),
  ...
  for(k in 1:strata){
    ...
    Z_mt <- rmvnorm(size,c(0,0,0,0),
                    matrix(c(gen_parm[[k]],0.5*gen_parm[[k]],0.5*gen_parm[[k]],0.5*gen_parm[[k]],
                             0.5*gen_parm[[k]],gen_parm[[k]]*gen_parm[[k]],0.5*gen_parm[[k]],0.5*gen_parm[[k]],
                             0.5*gen_parm[[k]],0.5*gen_parm[[k]],gen_parm[[k]],0.5*gen_parm[[k]],
                             0.5*gen_parm[[k]],0.5*gen_parm[[k]],0.5*gen_parm[[k]],gen_parm[[k]]),nrow=4))
    ...
    cp_casecohort[-sub_sample,][which(cp_casecohort[-sub_sample,]$disease != 1),"cc_sel"] <- 0  
